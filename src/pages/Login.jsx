...
//       const { user } = data;
//       if (!user.token) throw new Error("No token received from server");

//       // ── Single setUser call with everything merged ──
//       // Normalize id → _id so AuthContext always has _id
//       setUser({
//         _id: user._id ?? user.id, // ← always _id
//         id: user._id ?? user.id, // keep both for compatibility
//         name: user.name,
//         email: user.email,

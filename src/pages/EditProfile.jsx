...
// // Custom brand icons (lucide-react removed these in v0.300+)
...
//   const saved = localStorage.getItem("zyft_profile");
//   if (saved) {
//     try {
...
//   name: "You Name",
//   handle: "@yourname",
//   bio: "Fitness enthusiast pushing limits everyday",
...
// const takenUsernames = ["sarahfit", "marcusfit", "davidk", "alexlift"]; // Mock database
...
//   const [previewImage, setPreviewImage] = useState(saved?.photo || null);
//   const [savedSuccess, setSavedSuccess] = useState(false);
//   const [activeField, setActiveField] = useState(null);
//   const [usernameStatus, setUsernameStatus] = useState("idle"); // idle, checking, available, taken
//   const [darkMode, setDarkMode] = useState(() => {
//     return localStorage.getItem("zyft_theme") !== "light";
//   });

//   const [formData, setFormData] = useState({
//     name: saved?.name || defaultProfile.name,
//     handle: saved?.handle || defaultProfile.handle,
//     bio: saved?.bio || defaultProfile.bio,
//     focus: saved?.focus || defaultProfile.focus,
//     email: saved?.email || defaultProfile.email,
//     phone: saved?.phone || defaultProfile.phone,
//     instagram: saved?.instagram || defaultProfile.instagram,
//     twitter: saved?.twitter || defaultProfile.twitter,
//     tiktok: saved?.tiktok || defaultProfile.tiktok,
//     fitnessLevel: saved?.fitnessLevel || defaultProfile.fitnessLevel,
//   });
...
//     const fields = [
//       formData.name !== defaultProfile.name,
//       formData.handle !== defaultProfile.handle,
//       formData.bio !== defaultProfile.bio && formData.bio.length > 10,
//       formData.focus !== defaultProfile.focus,
//       formData.email !== defaultProfile.email,
//       formData.phone !== defaultProfile.phone,
//       !!previewImage,
...
//   useEffect(() => {
//     const username = formData.handle.replace("@", "");
...
//     const dataToSave = { ...formData, photo: previewImage };
//     localStorage.setItem("zyft_profile", JSON.stringify(dataToSave));
...
//   const InputWrapper = ({ label, field, children, hint, error }) => (
...
//           <InputWrapper label="Display Name" field="name">
//             <input
//               type="text"
//               name="name"
//               value={formData.name}
...
//             label="Username"
//             field="handle"
//             error={usernameStatus === "taken" ? "Username already taken" : null}
//           >
...
//                   type="button"
//                   onClick={() =>
//                     setFormData({ ...formData, fitnessLevel: level.value })
//                   }
...
//           <InputWrapper label="Fitness Focus" field="focus">
//             <input
//               type="text"
//               name="focus"
//               value={formData.focus}
//               onChange={handleChange}
//               onFocus={() => setActiveField("focus")}
//               onBlur={() => setActiveField(null)}
...
//           <InputWrapper label="Email" field="email">
//             <input
//               type="email"
//               name="email"
...
//           <InputWrapper label="Phone" field="phone">
//             <input
//               type="tel"
//               name="phone"
...
//           <InputWrapper label="Instagram" field="instagram">
//             <div className="relative">
//               <InstagramIcon
//                 size={14}
...
//           <InputWrapper label="Twitter / X" field="twitter">
//             <div className="relative">
//               <TwitterIcon
//                 size={14}
//                 className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500"
...
//           <InputWrapper label="TikTok" field="tiktok">
//             <div className="relative">
//               <TikTokIcon
//                 size={14}
//                 className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500"
...
export default function EditProfile() {
  ...
  const handleSubmit = useCallback(
    ...
    [formData, navigate, setUser, showToast],
  );

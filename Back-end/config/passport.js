...
// Load env vars FIRST — this module is evaluated before server.js's body
// runs (ESM imports are hoisted), so without this import the OAuth
// strategies below would see undefined clientID/clientSecret.
import './loadEnv.js';
...
// (kept outside initPassport — no env dependency)
...
// Strategies are constructed INSIDE this function — not at module
// top-level — so construction order is controlled explicitly by
// server.js (which calls initPassport() after env loading), rather than
// implicitly by ESM import order.

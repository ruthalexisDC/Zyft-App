...
//     // Avoid divide by zero — if no split set, default to 7
//     const totalPlannedDays = plannedWorkoutDays || 7;

//     // ── Run all queries in parallel ──
//     const [weekWorkouts, weekCaloriesAgg, goals, workoutsThisWeek] =
//       await Promise.all([

//         // 1. Workouts logged this week
//         Workout.countDocuments({
//           user: userId,
//           createdAt: { $gte: weekStart, $lte: todayEnd },
//         }),

//         // 2. Calories burned this week
//         Workout.aggregate([
//           {
//             $match: {
...
//         // 4. Get this week's workouts to check split compliance
//         Workout.find({
//           user: userId,
//           createdAt: { $gte: weekStart, $lte: todayEnd },
//         }).select("createdAt"),
...
//     // Map each workout to the day of week it happened (0=Mon, 6=Sun)
...
//     // Count how many planned workout days were actually hit
...
//     // Consistency = % of planned workout days completed
...
//       if (goal.type === "calories") current = weekCaloriesAgg[0]?.total ?? 0;
...
//       calories: weekCaloriesAgg[0]?.total ?? 0,
//       consistency,
//       goalsCompleted: goals.filter((g) => g.completed).length,
//       totalGoals: goals.length,
//       // Optional: send extra info for debugging/display
//       splitCompliance: {
...
// // ── Reset today's goal progress (call at midnight or on new day) ──

...
const userSchema = new mongoose.Schema(
  {
    ...
    // Notification preferences — which activity types generate a notification
    notificationPreferences: {
      respect: { type: Boolean, default: true },  // likes/"respects" on your posts
      comment: { type: Boolean, default: true },  // comments + mentions
      follow:  { type: Boolean, default: true },  // new followers
    },
